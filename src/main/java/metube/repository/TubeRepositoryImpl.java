...
public class TubeRepositoryImpl implements TubeRepository {
    ...
    public Optional<Tube> findByName(String name) {
        try {
            Optional<Tube> tube = Optional.of(entityManager.createQuery
                    ("SELECT t FROM tubes t WHERE t.name = :name", Tube.class).
    ...
    public Optional<Tube> findById(String s) {
        try {
            Optional<Tube> tube = Optional.of(entityManager.createQuery
                    ("SELECT t FROM tubes t WHERE t.id = :id", Tube.class).
